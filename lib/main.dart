        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ButtonBar(
              ...
              children: [
                Text('Mr.Hammonds Class', style: Theme.of(context).textTheme.headlineSmall,),
                ElevatedButton(onPressed: _goToHPickPeriodPage, child: const Text('Click Here'))
              ],
            ),
            const Divider(),
            ButtonBar(
              alignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text('Mr.Reeds Class', style: Theme.of(context).textTheme.headlineSmall,),
                ElevatedButton(onPressed: _goToRPickPeriodPage, child: const Text('Click Here'))
              ],
            ),
            const Spacer(),
          ],
